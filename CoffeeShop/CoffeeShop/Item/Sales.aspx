     ...
     <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                ...
                <asp:Label runat="server" ID="lblTotalCost" AssociatedControlID="txtTotalCost" CssClass="control-label">Total Cost</asp:Label>
            ...
            <div class="col-md-offset-2 col-md-3">
                ...
                <asp:Button runat="server" ID="PrintButton" Text="Print" CssClass="btn btn-info" />
            </div>
        </div>
    </div>
